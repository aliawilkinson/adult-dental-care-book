...
Inspected source: `3b91a2ea262ea170ab152be6aec140ed4bf11a55`. Existing prose and author decisions are retained. Structured context is an evidence-backed draft for Alia’s review; each unresolved operation is explicitly unknown.

- [product:adult-dental-care-book](context.md) — edit `docs/context.json`.
...
- Future tagged source archives include `docs/` so context travels with release source. The workflow was inspected; packaging/publishing was not executed.
